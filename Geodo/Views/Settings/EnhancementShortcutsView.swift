            ...
            HStack(alignment: .center, spacing: 12) {
                HStack(spacing: 4) {
                    ...
                    InfoTip(
                        ...
                        message: "Quickly enable or disable AI enhancement while recording. Available only when Geodo is running and the recorder is visible.",
            ...
            HStack(alignment: .center, spacing: 12) {
                HStack(spacing: 4) {
                    ...
                    InfoTip(
                        ...
                        message: "Switch between your saved prompts using ⌘1 through ⌘0 to activate the corresponding prompt in the order they are saved. Available only when Geodo is running and the recorder is visible.",
                        learnMoreURL: "https://tryvoiceink.com/docs/enhancement-shortcuts"
                    )
                }
