    ...
    var body: some View {
        ScrollView {
            VStack(spacing: 24) {
                ...
                SettingsSection(
                    icon: "command.circle",
                    title: "Geodo Shortcuts",
                    subtitle: "Choose how you want to trigger Geodo"
                ) {
                ...
                SettingsSection(
                    ...
                    subtitle: "Additional shortcuts for Geodo"
                ) {
                    VStack(alignment: .leading, spacing: 18) {
                        ...
                        ExpandableToggleSection(
                            ...
                            helpText: "Use middle mouse button to toggle Geodo recording.",
                ...
                SettingsSection(
                    ...
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        ExpandableToggleSection(
                            ...
                            helpText: "When enabled, Geodo will restore your original clipboard content after pasting the transcription.",
            ...
            HStack(spacing: 12) {
                ...
                if showWarning {
                    ...
                    Image(systemName: "exclamationmark.triangle.fill")
                        .foregroundColor(.red)
                        .help("Permission required for Geodo to function properly")
                }
            }
...
struct PermissionsSettingsSection: View {
    ...
    var body: some View {
        SettingsSection(
            ...
            title: "Permissions",
            subtitle: "Required permissions for Geodo to function",
