    ...
    private var metricsCardsSection: some View {
        LazyVGrid(columns: [GridItem(.adaptive(minimum: 200), spacing: 16)], spacing: 16) {
            MetricCard(
                ...
                detail: "Geodo sessions completed",
                color: .purple
            )
            ...
            MetricCard(
                ...
                value: averageWordsPerMinute > 0
                    ...
                    : "–",
                detail: "Geodo vs. typing by hand",
                color: .yellow
            )
            ...
            VStack(spacing: 16) {
                HStack(spacing: 16) {
                    ...
                    HStack(alignment: .lastTextBaseline, spacing: 8) { 
                        Text(licenseViewModel.licenseState == .licensed ? "Geodo Beta" : "Upgrade to Beta")
                ...
                Text(licenseViewModel.licenseState == .licensed ?
                     "Thank you for supporting Geodo" :
        ...
        VStack(spacing: 32) {
            ...
            VStack(spacing: 24) {
                ...
                if licenseViewModel.activationsLimit > 0 {
                    ...
                    Text("You can use Geodo Beta on all your personal devices")
                        .font(.subheadline)
                        .foregroundStyle(.secondary)
                }
            }
