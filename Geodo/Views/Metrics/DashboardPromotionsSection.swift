            ...
            HStack(alignment: .top, spacing: 18) {
                if shouldShowUpgradePromotion {
                    DashboardPromotionCard(
                        badge: "30% OFF",
                        title: "Unlock Geodo Beta For Less",
                        message: "Share Geodo on your socials, and instantly unlock a 30% discount on Geodo Beta.",
                ...
                if shouldShowAffiliatePromotion {
                    DashboardPromotionCard(
                        badge: "AFFILIATE 30%",
                        title: "Earn With The Geodo Affiliate Program",
                        message: "Share Geodo with friends or your audience and receive 30% on every referral that upgrades.",
